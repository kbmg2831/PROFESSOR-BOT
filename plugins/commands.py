...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton(' 🔥𝐌𝐚𝐢𝐧 𝐂𝐡𝐚𝐧𝐧𝐞𝐥🔥 ', url=f'https://t.me/TamilRockerz_TR')
            ],[
            InlineKeyboardButton('ℹ️ 𝐇𝐞𝐥𝐩 ℹ️', url=f"https://t.me/{temp.U_NAME}?start=help")
            ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton(" 🔥𝐌𝐚𝐢𝐧 𝐂𝐡𝐚𝐧𝐧𝐞𝐥🔥 ", url="https://t.me/TamilRockerz_TR")
            ],[      
            InlineKeyboardButton("ℹ️ 𝐇𝐞𝐥𝐩 ℹ️", callback_data="help"),
